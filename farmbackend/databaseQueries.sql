...
ALTER TABLE Administrators ADD INDEX FKAdministra284009 (UsersID), ADD CONSTRAINT FKAdministra284009 FOREIGN KEY (UsersID) REFERENCES Users (ID) ON DELETE Cascade;
